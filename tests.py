...
class PartyTestsDatabaseLoggedIn(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn("Tic-tac-toe", result.data)
        self.assertIn("Pacman", result.data)
...
class PartyTestsDatabaseLoggedOut(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Not needed because testing where RSVP = NULL/False
        # with self.client as c:
        #     with c.session_transaction() as sess:
        #         sess['booger'] = {}
    ...
    def test_games(self):
        ...
        self.assertNotIn("Tic-tac-toe", result.data)
        # print result.data
        self.assertNotIn("Pacman", result.data)
        self.assertIn("Please RSVP", result.data)
